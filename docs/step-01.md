...
1. Create a Helm Chart
    ...
    This generates a basic chart scaffold. We clean up the default files and organize our templates under `templates/postgres/`.
...
4. Install the chart in your cluster
    ...
    ```bash
    helm install gita-postgres ./gita-io \
...
6. Connect to Postgres
    ...
    ```bash
    kubectl port-forward service/gita-postgres-gita-io 5432:5432 -n postgres
